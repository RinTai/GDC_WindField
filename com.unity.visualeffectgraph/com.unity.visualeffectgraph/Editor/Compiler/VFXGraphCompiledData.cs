...
namespace UnityEditor.VFX
{
    struct VFXContextCompiledData
    {
        ...
        public ReadOnlyDictionary<VFXExpression, BufferUsage> graphicsBufferUsage;
    ...
    class VFXGraphCompiledData
    {
        ...
        private void GenerateShaders(List<GeneratedCodeData> outGeneratedCodeData, VFXExpressionGraph graph, IEnumerable<VFXContext> contexts, 
            Dictionary<VFXContext, VFXContextCompiledData> contextToCompiledData, VFXCompilationMode compilationMode, 
            HashSet<string> dependencies, bool enableShaderDebugSymbols, Dictionary<VFXContext, VFXExpressionMapper> gpuMappers)
        {
            ...
            try
            {
                foreach (var context in contexts)
                {
                    ...
                    contextData.graphicsBufferUsage = graph.GetBufferTypeUsage(context);
        ...
        public void Compile(VFXCompilationMode compilationMode, bool forceShaderValidation, bool enableShaderDebugSymbols)
        {
            ...
            try
            {
                ...
                GenerateShaders(generatedCodeData, m_ExpressionGraph, compilableContexts, contextToCompiledData, 
                    compilationMode, sourceDependencies, enableShaderDebugSymbols, gpuMappers);
